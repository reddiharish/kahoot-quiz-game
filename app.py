...
def init_db():
    ...
    if cursor.fetchone()[0] == 0:
        sample_questions = [
            ...
            ("Where is the university SPSU located?", "Udaipur", "Hyderabad", "Mumbai", "Bangalore", 1),
            ("What is the first element in the periodic table?", "Hydrogen", "Helium", "Carbon", "Boron", 1)
...
def quiz():
    if request.method == 'POST':
        ...
        if selected_option == correct_option[0]:
        ...
        if not questions:
            return "No questions available, please add some!"
